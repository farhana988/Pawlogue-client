      ...
      <section className="">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:gap-7 items-center px-4">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold  text-[#299173]
             dark:text-[#ff5959fa]  mb-6 tracking-tight">
              Give Them a Loving Home
            </h2>
            <p className="text-sm md:text-base xl:text-xl opacity-80 mb-6 leading-relaxed">
