...
<section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm">
          ...
          These third parties are required to protect your information and only
          use it for the specific purpose for which it was shared.
        </p>
      </div>
</section>
<section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm">
          ...
          Any changes will be posted on this page with an updated date. Please
