  ...
  return (
    <Container>
      ...
      <div className="mb-8">
        ...
        <p className="lg:text-lg">
          By accessing or using the Pawlogue website and services, you agree to
          be bound by these Terms and Conditions and all applicable laws and
          regulations. If you do not agree to these terms, you must not use our
          services.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="lg:text-lg">
          Our Privacy Policy governs the collection and use of personal data. By
      ...
      <div className="mb-8">
        ...
        <p className="lg:text-lg">
          ...
          services at any time, without notice, for violation of these Terms and
          Conditions or any other conduct we deem harmful to our platform or
          other users.
        </p>
      </div>
