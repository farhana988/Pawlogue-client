        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-12 ">
          ...
          <div className="flex flex-col items-center rounded-lg shadow-lg bg-lCard dark:bg-dCard p-8">
            ...
            <p className="mb-6 text-sm lg:text-lg">
              Adopting a pet gives an animal a second chance at life, reduces
              the number of homeless pets, and supports ethical pet ownership.
            </p>
        ...
        <div className="flex flex-col gap-6 mb-12 ">
          <div className="flex flex-col items-center rounded-lg shadow-lg bg-lCard dark:bg-dCard p-8">
            ...
            <p className="mb-6 text-sm lg:text-lg">
              ...
              rescuing and rehoming pets in need. Every contribution makes a
              lasting impact on the lives of these animals and helps us ensure
            ...
            <div className=" text-xs lg:text-lg grid grid-cols-1 lg:grid-cols-2 lg:gap-6">
              ...
              <p>
                <strong className="text-base lg:text-xl">Emergency Rescue and Special Cases:</strong> Many animals come to us in critical need—injured, sick, or in dire circumstances. Your donations help provide life-saving surgeries, emergency treatments, and urgent care for these special cases.
              </p>
              </span>
