...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <div className="text-xl flex justify-center items-center gap-2 font-semibold">
          <Link to="/" className="flex items-center gap-2">
            {/* Website Logo */}
            <img className="w-10 xl:w-12" src={logo} alt="Pawlogue Logo" />
            {/* Name */}
            <div className="text-nav dark:text-ivory font-snow lg:flex gap-4 relative items-center justify-center hidden">
              <span>Pa</span>
              <img
                className="w-12 -top-2 left-2 object-cover absolute -rotate-12"
                src={paw}
                alt="Paw"
              />
              <span>logue</span>
        ...
        <div className="hidden md:flex space-x-4 lg:space-x-8 items-center">
          ...
          {user ? (
            ...
            <Link
              to="/login"
              className="font-semibold px-5 py-[6px] rounded-full text-sm lg:text-base bg-lBtn dark:bg-dBtn transition"
            >
              Login
            </Link>
          )}
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <button
            ...
            className="text-black dark:text-white focus:outline-none transition"
          >
            {isMenuOpen ? (
              <svg
