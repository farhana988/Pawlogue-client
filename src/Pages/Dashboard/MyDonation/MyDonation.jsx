        ...
        try {
            ...
            if (result.isConfirmed) {
                ...
                if (res.data.deletedCount > 0) {
                    ...
                    Swal.fire("Error!", "Could not process the refund. Please try again.", "error");
                }
            }
        } catch (error) {
                ...
                <table className="table-auto w-full border-collapse border border-gray-300">
                    <thead>
                        <tr>
                            ...
                            <th className="border border-gray-300 px-4 py-2">Donated Amount</th>
                        ...
                        {donations.map((donation) => (
                            <tr key={donation.transactionId}>
                                <td className="border border-gray-300 px-4 py-2">
                                    <img src={donation.petImage} alt={donation.petName} className="h-16 w-16 object-cover rounded-full" />
                                </td>
                                <td className="border border-gray-300 px-4 py-2">{donation.petName}</td>
                                <td className="border border-gray-300 px-4 py-2">{donation.donatedAmount} USD</td>
                                <td className="border border-gray-300 px-4 py-2">
                                    <button
